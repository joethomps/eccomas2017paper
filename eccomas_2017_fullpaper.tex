...
The Lanczos algorithm may be used to calculate matrices $J$ and $U$ ($X^T$) for a given $\Lambda$ and $\mathbf{x_1}$ such that $J U = U \Lambda$ (where $J$ is a Jacobi matrix and $U U^T = I$).
